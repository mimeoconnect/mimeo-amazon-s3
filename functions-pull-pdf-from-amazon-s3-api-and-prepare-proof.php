<h1>Pulling a PDF from Amazon S3 and Proofing with Mimeo</h1>
<p>This is a sample / training document on how to pull a PDF file from Amazon S3 then Proof with the Mimeo Proof Web Service.</p>
...
?>
<p>My goal is to pull a public file (either ACL or bucket policy) from Amazon S3, I have chosen: <a href="<?php echo $AmazonS3_Document_URL;?>" target="_blank"><?php echo $AmazonS3_Document_URL;?></a></strong></p>
<?php
...
?>
<p>Using the Amazon S3 PDF Download URL we pass to Mimeo Connect RESTful Cloud Print Proof Service and get the following XML:</p>
...
<p>The goal of this is to show how to pull PDF from Amazon S3, Proof with Mimeo Cloud Print API and display to user prior to ordering print copies of a document.</p>
